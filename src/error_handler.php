...
class error_handler {
    ...
    public function exception_handler($e) {
        [$message, $trace] = self::message_trace($e);
        self::render_exception_page($e, $message, $trace);
        error_log(date("Y-m-d H:i:s") . " " . $message . "\n" . $trace . "\n", 3, $this->error_logfile);
    }

    static public function dev_exeption_page(Throwable $e): array {
        [$message, $trace] = self::message_trace($e);
    ...
    public function fatal_handler() {
        ...
        print self::render_exception_page(null, $message, $trace);
    }
     ...
     */
    static public function render_exception_page($e, $message, $trace) {
        while (ob_get_level()) ob_end_clean();
