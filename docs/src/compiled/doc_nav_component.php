...
class doc_nav_component extends component {
    public string $uid = "doc_nav---681652736200b";
    public bool $is_layout = false;
    public string $name = "doc_nav";
    public string $tagname = "doc.nav";
...
$current_section = $props->current->dir ? basename($props->current->dir) : basename($chapters->index[0]->_file->dir);
    ...
    public function debug_info(){
        return array (
  'src' => '/Users/rw/dev/slowfoot/docs_src/src/components/doc_nav.phue.php',
  'php' => 10,
);
    }
}
