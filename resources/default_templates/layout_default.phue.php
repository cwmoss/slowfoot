...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --border-color: oklch(92% .004 286.32);
            ...
            --shadow: 0px 10px 15px -3px #0000001a, 0px 4px 6px -2px #0000000d;
        ...
        * {
        ...
        dialog[drawer] {
            ...
            &[open] {
                animation: .2s ease-in forwards slideup
            }
        }
        ...
        dialog[sheet-top][open] {
            animation: .2s ease-in forwards slidedown
        }
        ...
        dialog[sheet-left][open] {
            animation: .2s ease-in forwards slideright
        }

        dialog[sheet-right][open] {
            animation: .2s ease-in forwards slideleft;
            left: auto;
            right: 0
        }
        ...
        div[skeleton] {
            ...
            border-radius: var(--radius);
            opacity: 1;
            animation: 2s cubic-bezier(.4, 0, .6, 1) infinite shimmer;
        ...
        dialog[toast] {
            ...
            &[open] {
                animation: .2s ease-in forwards slideup, .2s ease-in forwards fad-in
            }
        }
...
<?php
// $css = file_get_contents(__DIR__ . "/assets/shadcn-classless.css");
$title = "some page";

// var_dump($css, __DIR__);
// print_r($phuety);
